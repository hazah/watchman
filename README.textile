...
We can
define how to process collections of objects that the user has certain permissions for. By
...
to hook into something like @ActiveRecord@ and specify rules for processing scopes. Supplying a resource
block will enable us to check authorization of individual objects and collections for requested
permissions.
